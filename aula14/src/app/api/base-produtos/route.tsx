...
export async function POST(request:Request, response:Response){
    ...
    //Inserir o novo produto que ja possui inclusive ID na lista de produtos:
    produtos.push(produto);

    //Processo de manipulação do arquivo com promises e precess.cwd para colocar a lista no arquivo e atualizar ele.
